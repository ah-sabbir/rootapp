    ...
    <div className="w-screen h-screen flex justify-center">
        ...
        <div className=" w-1/2 h-full items-center bg-blue-light flex">
                ...
                <div className="mb-4 md:w-full">
                    <input className="w-full border rounded p-2 outline-none focus:shadow-outline" type="text" name="firstName" id="firstName" placeholder="First Name"/>
                </div>
                <div className="mb-4 md:w-full">
                    <input className="w-full border rounded p-2 outline-none focus:shadow-outline" type="text" name="lastName" id="lastName" placeholder="Last Name"/>
                </div>
                <div className="mb-4 md:w-full">
                ...
                <button className="  bg-blue-dark hover:bg-green-700 text-white uppercase text-sm font-semibold px-4 py-2 inline-flex rounded-md shadow">submit</button>
                </form>
