        ...
        <div className="w-1/2 pr-0">
            <div className="flex relative inline-block float-right">
                ...
                <div className="relative text-sm text-gray-100">
                    ...
                    <Image className="w-8 h-8 rounded-full mr-4" src={this.state.profileImageUrl}  height="45" width="45"  alt="Avatar of User"/> <span className="hidden md:inline-block text-gray-100">Hi, User</span>
                    <svg className="pl-2 h-2 fill-current text-gray-100" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 129 129" xmlnsXlink="http://www.w3.org/1999/xlink" enableBackground="new 0 0 129 129"><g><path d="m121.3,34.6c-1.6-1.6-4.2-1.6-5.8,0l-51,51.1-51.1-51.1c-1.6-1.6-4.2-1.6-5.8,0-1.6,1.6-1.6,4.2 0,5.8l53.9,53.9c0.8,0.8 1.8,1.2 2.9,1.2 1,0 2.1-0.4 2.9-1.2l53.9-53.9c1.7-1.6 1.7-4.2 0.1-5.8z"/></g></svg>
                </button>
