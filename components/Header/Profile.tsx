        ...
        <div className="w-1/2 pr-0">
            <div className="flex relative inline-block float-right">
                ...
                <div className="relative text-sm text-gray-100">
                    ...
                    <Image className="w-8 h-8 rounded-full mr-4" src={`i.pravatar.cc`}  height="45" width="45"  alt="User"/> <span className="hidden md:inline-block text-gray-100">Hi, User</span>
