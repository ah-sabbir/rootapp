        ...
        <div>
            <div id="header" className="bg-gray-900 fixed w-full z-10 top-0 shadow">
                ...
                <div className="w-1/2 pl-2 md:pl-0">
                    ...
                    <i className="fas fa-moon text-blue-400 pr-3"></i> Task Time
                    </a>
                        </div>
                <div className="w-1/2 pr-0">
                    ...
                    <div className="relative text-sm text-gray-100">
                        ...
                        <Image className="w-8 h-8 rounded-full mr-4" width={100} height={100} loader={myLoader} src={`https://i.pravatar.cc/152`} alt="Avatar of User"/> <span className="hidden md:inline-block text-gray-100">Hi, User</span>
